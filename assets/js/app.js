  ...
  fetchData(url.currentWeather(lat, lon), function (currentWeather) {
    ...
    card.innerHTML = `
      ...
      <div class="weapper">
        ...
        <img src="./assets/images/weather_icons/${icon}.png" width="69" height="69" alt="${description}"
          class="weather-icon">
      </div>
      ...
      for (const [index, data] of forecastList.entries()) {
        ...
        tempLi.innerHTML = `
          <div class="card card-sm slider-card">
            ...
            <img src="./assets/images/weather_icons/${icon}.png" width="70" height="70" loading="lazy" alt="${description}"
      ...
      for (let i = 7, len = forecastList.length; i < len; i += 8) {
        ...
        li.innerHTML = `
          <div class="icon-wrapper">
            <img src="./assets/images/weather_icons/${icon}.png" width="44" height="44" alt="${description}"
              class="weather-icon" title="${description}">
